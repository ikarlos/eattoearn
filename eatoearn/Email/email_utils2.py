...
# def send_benifit_success(user_name: str, user_email: str):
#     # Define HTML content for the email template
#     html_content = f"""
#     <!DOCTYPE html>
#     <html lang="en">
...
#     <meta charset="UTF-8">
#     <meta name="viewport" content="width=device-width, initial-scale=1.0">
#     <title>Free Plan Benefits</title>
#     <style>
#         body {{
#             font-family: Arial, sans-serif;
#             margin: 0;
...
#         <p>Greetings from EatoEarn</p>
#         <p>You have received your free plan benefits! You can now order any of these foods within the specified time period.</p>
#         <p><strong>Note:</strong> If you don’t use these benefits in the specific time period, it will expire and you will have no benefit of it!</p>
#         <p>We are happy to help you if you face any issue.</p>
#         <p>Best Regards,</p>
#         <p>Team EatoEarn</p>
...
#     msg["From"] = "support@eatoearn.com"
#     msg["To"] = user_email
#     msg["Subject"] = "Your plan benefits"
